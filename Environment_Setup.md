# Environment
This is not absolutely important but if you have a good coding environment it will be really helpful.
**Note:** Guys who are planning to go to IT field, I highly suggest buying a good laptop, add 10k extra to your budget and get a very good laptop as you are going to spend most of your time on it.
## Tools:
* VS code: This is a code editor, you know the typical movie coder vibes, but this is very good as it allows developers to write, edit, run, and debug code for virtually any programming language across Windows, macOS, and Linux. [Setting VS Code](https://www.youtube.com/watch?v=D2cwvpJSBX4)
...
* I also recommend creating atleast two new google accounts, one for personal use and other for professional use.
